...
class IndexSeasonRecordController extends Controller
{
    public function __invoke(IndexRecordRequest $request, GrowingSeason $growingSeason): JsonResponse
    {
        Gate::authorize('view', $growingSeason);
        $query = $growingSeason->records();
