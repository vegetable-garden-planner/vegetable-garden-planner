 ...
 *
 * 선택지는 같은 공간을 서로 다른 빛에서 담은 사진 세 장으로 보여 준다.
 * 눈금으로 단계를 한 번 더 확인시키고, 선택하면 그 장면이 또렷해진다.
 */
...
export const LIGHT_OPTIONS: readonly LightOption[] = [
  {
    ...
    photo: "/images/start/sunlight-soft.webp",
  ...
  },
  {
    ...
    photo: "/images/start/sunlight-medium.webp",
  ...
  },
  {
    ...
    photo: "/images/start/sunlight-strong.webp",
          ...
          {LIGHT_OPTIONS.map((option) => {
            ...
            return (
              <button
                ...
                type="button"
              >
                {/* 같은 공간, 서로 다른 빛 — 사진이 차이를 그대로 보여 준다 */}
