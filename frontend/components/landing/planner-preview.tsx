  ...
  return (
    <div id="planner" className="relative mx-auto w-full max-w-2xl scroll-mt-24">
      <div className="overflow-hidden rounded-[2rem] border border-white/80 bg-paper shadow-[0_30px_80px_rgba(45,65,44,0.16)]">
        ...
        <div className="flex items-start gap-3 border-t border-[#efd49b] bg-[#fff8e7] px-5 py-3.5 text-[#8b5b18] sm:px-7">
          <span className="mt-0.5 text-sm" aria-hidden="true">✓</span>
          <div>
            <p className="text-xs font-bold">간격 검사를 완료했어요</p>
            <p className="mt-0.5 text-[11px] text-[#98713d]">현재 배치에서 위험 요소가 없어요.</p>
          </div>
        </div>

        <div className="grid grid-cols-2 border-t border-ink/8 bg-white/70 px-4 py-4 text-center sm:grid-cols-4">
          <div>
            <p className="text-[11px] text-muted">밭 크기</p>
            <p className="mt-1 text-sm font-bold">4m × 3m</p>
          </div>
          <div className="border-l border-ink/8">
            <p className="text-[11px] text-muted">선택 작물</p>
            <p className="mt-1 text-sm font-bold">4종</p>
          </div>
          <div className="mt-4 border-r border-ink/8 pt-4 sm:mt-0 sm:border-l sm:pt-0">
            <p className="text-[11px] text-muted">예상 수량</p>
            <p className="mt-1 text-sm font-bold">32포기</p>
          </div>
          <div className="mt-4 pt-4 sm:mt-0 sm:pt-0">
