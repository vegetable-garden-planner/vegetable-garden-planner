        ...
        <div className="mx-auto max-w-4xl">
          <header className="flex flex-wrap items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2">
              <AuthHeaderMenu />
              <Link className="rounded-full border border-ink/15 px-4 py-2.5 text-sm font-bold" href="/spaces">공간 관리</Link>
              <Link className="rounded-full bg-leaf px-4 py-2.5 text-sm font-bold text-white" href="/seasons/new">시즌 추가</Link>
            </div>
          </header>
